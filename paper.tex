...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.96\columnwidth]{./fig/cstg_diff_pretty.png}
...
\paragraph{Diagnosing floating-point exceptions}
...
\paragraph{GPU Exception Tracking}
