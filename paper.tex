...
\texttt{rand(odds)} returns \texttt{1}, then \FT{} inspects the
...
Since \FT{} checks if it should inject a \Nan{} at \emph{every} \fp{}
...
\FT{} and \GPUFPX{} have no formal connection---that is, one does not
need to use \GPUFPX{} with \FT{}, nor vice-versa.
...
\GPUFPX and \FT{} can both aid in tracking down exceptional \fp{}
values.
