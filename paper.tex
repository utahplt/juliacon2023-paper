...
For example, adding the tiny Planck constant to the large Avogadro number results in
the Avogadro number after rounding:
...
implemented in Julia as a library and is available on JuliaHub (TODO update link):
