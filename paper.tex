...
% This is the story that I think we want to tell: you're going to run into NaNs,
% so instead of dialing the the value down, we should look for where NaNs first
% start to appear and fix those places.
...
% Local Variables:
% jinx-local-words: "CFL CSTGs Courant Friedrichs JuliaHub Lewy OrdinaryDiffEq ShallowWaters TrackedFloat isnan"
% End:
