...
# We talk about this in the [[ShallowWaters]] section
...
# Show picture of output

ShallowWaters was interesting to use because it let you parameterize the type of float used in the simulation. So we were able to enable FloatTracker with a simple modification to the code:
...
# TODO: show code to fuzz the program
...
# Local Variables:
# jinx-local-words: "ShallowWaters"
# End:
